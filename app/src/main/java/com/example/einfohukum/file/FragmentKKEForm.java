...
public class FragmentKKEForm extends Fragment
{
    private static final String URL_ROOT = URLS.URL_UTAMA;

    public static final String URL_AGAM= URL_ROOT + "/Kabupaten_Agam/simpankke.php";
    public static final String URL_TANAHD= URL_ROOT + "/Kabupaten_Tanah_Datar/simpankke.php";
    public static final String URL_DAHAMS= URL_ROOT + "/Kabupaten_Dharmasraya/simpankke.php";
    public static final String URL_MENTAWAI= URL_ROOT + "/Kabupaten_Kepulauan_Mentawai/simpankke.php";
    public static final String URL_LIMAPULUH= URL_ROOT + "/Kabupaten_Lima_Puluh_Kota/simpankke.php";
    public static final String URL_PARIAMAN= URL_ROOT + "/Kabupaten_Padang_Pariaman/simpankke.php";
    public static final String URL_PASAMAN= URL_ROOT + "/Kabupaten_Pasaman/simpankke.php";
    public static final String URL_PASBAR= URL_ROOT + "/Kabupaten_Pasaman_Barat/simpankke.php";
    public static final String URL_PESISIR= URL_ROOT + "/Kabupaten_Pesisir_Selatan/simpankke.php";
    public static final String URL_SIJUNJUNG= URL_ROOT + "/Kabupaten_Sijunjung/simpankke.php";
    public static final String URL_SOLOK= URL_ROOT + "/Kabupaten_Solok/simpankke.php";
    public static final String URL_SOLSEL= URL_ROOT + "/Kabupaten_Solok_Selatan/simpankke.php";
    public static final String URL_BUKKITTINGGI= URL_ROOT + "/Kota_Bukittinggi/simpankke.php";
    public static final String URL_PADANG= URL_ROOT + "/Kota_Padang/simpankke.php";
    public static final String URL_PADANGPANJANG= URL_ROOT + "/Kota_Padang_Panjang/simpankke.php";
    public static final String URL_KOTPARIAMAN= URL_ROOT + "/Kota_Pariaman/simpankke.php";
    public static final String URL_SAWAHLUNTO= URL_ROOT + "/Kota_Sawahlunto/simpankke.php";
    public static final String URL_KOTSOLOK= URL_ROOT + "/Kota_Solok/simpankke.php";
    public static final String URL_PYK= URL_ROOT + "/Kota_Payakumbuh/simpankke.php";
    ...
    private FragmentKKEForm.OnFragmentInteractionListener mListener;

    public FragmentKKEForm() {
    ...
    public static FragmentKKEForm newInstance(String param1, String param2) {
        FragmentKKEForm fragment = new FragmentKKEForm();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        new FragmentKKEForm.myikc().execute();

        return inflater.inflate(R.layout.fragment_kke_form, container, false);
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof FragmentKKEForm.OnFragmentInteractionListener) {
            mListener = (FragmentKKEForm.OnFragmentInteractionListener) context;
        } else {
