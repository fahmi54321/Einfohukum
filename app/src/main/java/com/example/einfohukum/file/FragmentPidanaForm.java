...
public class FragmentPidanaForm extends Fragment
{

    private static final String URL_ROOT = URLS.URL_UTAMA;

    public static final String URL_AGAM= URL_ROOT + "/Kabupaten_Agam/simpanpidana.php";
    public static final String URL_TANAHD= URL_ROOT + "/Kabupaten_Tanah_Datar/simpanpidana.php";
    public static final String URL_DAHAMS= URL_ROOT + "/Kabupaten_Dharmasraya/simpanpidana.php";
    public static final String URL_MENTAWAI= URL_ROOT + "/Kabupaten_Kepulauan_Mentawai/simpanpidana.php";
    public static final String URL_LIMAPULUH= URL_ROOT + "/Kabupaten_Lima_Puluh_Kota/simpanpidana.php";
    public static final String URL_PARIAMAN= URL_ROOT + "/Kabupaten_Padang_Pariaman/simpanpidana.php";
    public static final String URL_PASAMAN= URL_ROOT + "/Kabupaten_Pasaman/simpanpidana.php";
    public static final String URL_PASBAR= URL_ROOT + "/Kabupaten_Pasaman_Barat/simpanpidana.php";
    public static final String URL_PESISIR= URL_ROOT + "/Kabupaten_Pesisir_Selatan/simpanpidana.php";
    public static final String URL_SIJUNJUNG= URL_ROOT + "/Kabupaten_Sijunjung/simpanpidana.php";
    public static final String URL_SOLOK= URL_ROOT + "/Kabupaten_Solok/simpanpidana.php";
    public static final String URL_SOLSEL= URL_ROOT + "/Kabupaten_Solok_Selatan/simpanpidana.php";
    public static final String URL_BUKKITTINGGI= URL_ROOT + "/Kota_Bukittinggi/simpanpidana.php";
    public static final String URL_PADANG= URL_ROOT + "/Kota_Padang/simpanpidana.php";
    public static final String URL_PADANGPANJANG= URL_ROOT + "/Kota_Padang_Panjang/simpanpidana.php";
    public static final String URL_KOTPARIAMAN= URL_ROOT + "/Kota_Pariaman/simpanpidana.php";
    public static final String URL_SAWAHLUNTO= URL_ROOT + "/Kota_Sawahlunto/simpanpidana.php";
    public static final String URL_KOTSOLOK= URL_ROOT + "/Kota_Solok/simpanpidana.php";
    public static final String URL_PYK= URL_ROOT + "/Kota_Payakumbuh/simpanpidana.php";
    ...
    private FragmentPidanaForm.OnFragmentInteractionListener mListener;

    public FragmentPidanaForm() {
    ...
    public static FragmentPidanaForm newInstance(String param1, String param2) {
        FragmentPidanaForm fragment = new FragmentPidanaForm();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new FragmentPidanaForm.myikc().execute();

        return inflater.inflate(R.layout.fragment_pidana_form, container, false);
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof FragmentPidanaForm.OnFragmentInteractionListener) {
            mListener = (FragmentPidanaForm.OnFragmentInteractionListener) context;
        } else {
